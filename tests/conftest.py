...
def lst_for_tests_csv_xlsx() -> list:
    ...
    return [{'Дата операции': Timestamp('2021-12-31 16:44:00'), 'Номер карты': '*7197',
             ...
             'Категория': 'Супермаркеты', 'Описание': 'Колхоз'}, {'Дата операции': Timestamp('2021-12-31 16:39:04'),
            ...
            {'Дата операции': Timestamp('2021-12-31 15:44:39'), 'Номер карты': '*7197', 'Статус': 'OK',
             ...
             'Валюта операции': 'RUB', 'Сумма платежа': -564.0, 'Валюта платежа': 'RUB', 'Категория': 'Различные товары',
                                     'Описание': 'Ozon.ru'}, {'Дата операции': Timestamp('2021-12-31 00:12:53'),
            ...
            {'Дата операции': Timestamp('2021-12-30 22:22:03'),
             'Номер карты': nan, 'Статус': 'OK', 'Сумма операции': -20000.0, 'Валюта операции': 'RUB', 'Сумма платежа': -20000.0,
             'Валюта платежа': 'RUB', 'Категория': 'Переводы', 'Описание': 'Константин Л.'},
            {'Дата операции': Timestamp('2021-12-30 19:18:22'), 'Номер карты': '*5091', 'Статус': 'OK','Сумма операции': -7.07,
             'Валюта операции': 'RUB', 'Сумма платежа': -7.07, 'Валюта платежа': 'RUB', 'Категория':
                'Каршеринг', 'Описание': 'Ситидрайв'}, {'Дата операции': Timestamp('2021-12-30 19:06:39'), 'Номер карты': '*7197',
            ...
            {'Дата операции': Timestamp('2021-12-30 17:50:30'), 'Номер карты': '*4556', 'Статус': 'OK', 'Сумма операции': 5046.0,
